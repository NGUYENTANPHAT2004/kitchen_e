...
// Authentication routes apply their own limits. Polling /me must never consume
// the failed-login quota or block a successful sign-in for an hour.
...
app.use("/api/settings", require("./routes/api/settings.routes"));
