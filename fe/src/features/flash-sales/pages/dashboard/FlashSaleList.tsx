...
const FlashSaleList: React.FC = () => {
  ...
  const handleDelete = (id: string) => {
    if (window.confirm("Xóa chương trình Flash Sale này?"))
  ...
  const handleToggleStatus = (sale: FlashSale) => {
    const next: FlashSale["status"] =
      sale.status === "active" ? "ended" : "active";
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="relative">
            <select
              ...
              value={filterStatus}
              onChange={(e) => {
                setFilterStatus(e.target.value as FlashSale["status"] | "");
                setPage(1);
              }}
            >
              ...
              <tr>
                <th className="px-3 py-3 text-left">
                  <input
                    ...
                    onChange={(e) =>
                      setSelectedIds(
                        e.target.checked ? sorted.map((s) => s._id) : []
                      )
                    }
                    checked={
                ...
                <tr key={sale._id} className="hover:bg-gray-50">
                  <td className="px-3 py-4">
                    <input
                      ...
                      onChange={() =>
                        setSelectedIds((ids) =>
                          ids.includes(sale._id)
                            ? ids.filter((i) => i !== sale._id)
                            : [...ids, sale._id]
                        )
                      }
                    />
                  ...
                  <td className="px-3 py-4 text-center">
                    <div className="flex items-center justify-center gap-2">
                      <Link
                        to={`/marketing/flash-sales/${sale._id}/edit`}
                      ...
                      {(sale.status === "scheduled" ||
                        ...
                        <button
                          ...
                          title={
                            sale.status === "active" ? "Kết thúc" : "Kích hoạt"
                          }
                        >
                          {sale.status === "active" ? (
